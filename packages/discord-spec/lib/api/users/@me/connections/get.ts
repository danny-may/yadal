 ...
 */
import { type ListMyConnectionsRequestHeaders, type ListMyConnectionsResponseJSON, type RateLimitError, type ErrorResponse } from '../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/users/@me/connections" as const,
        keys: Object.freeze([] as const),
        segments: Object.freeze(["/users/@me/connections"] as const)
    }),
...
Object.freeze(query);
export type HeaderModel = ListMyConnectionsRequestHeaders;
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as ListMyConnectionsResponseJSON;
        }
