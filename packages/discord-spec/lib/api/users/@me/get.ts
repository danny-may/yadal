 ...
 */
import { type GetMyUserRequestHeaders, type UserPIIResponse, type RateLimitError, type ErrorResponse } from '../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/users/@me" as const,
        keys: Object.freeze([] as const),
        segments: Object.freeze(["/users/@me"] as const)
    }),
...
Object.freeze(query);
export type HeaderModel = GetMyUserRequestHeaders;
