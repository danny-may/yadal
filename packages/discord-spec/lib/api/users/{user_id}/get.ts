 ...
 */
import { type GetUserRequestPath, type GetUserRequestHeaders, type UserResponse, type RateLimitError, type ErrorResponse } from '../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/users/{user_id}" as const,
        keys: Object.freeze(["user_id"] as const),
        segments: Object.freeze(["/users/",""] as const)
    }),
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as UserResponse;
        }
