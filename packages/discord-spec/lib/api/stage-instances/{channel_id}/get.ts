 ...
 */
import { type GetStageInstanceRequestPath, type GetStageInstanceRequestHeaders, type StageInstanceResponse, type RateLimitError, type ErrorResponse } from '../../../types.js';
import { DiscordRestError, DiscordRateLimitError } from '../../../helpers.js';
export const name = "getStageInstance";
export type RouteModel = GetStageInstanceRequestPath;
const routeRegex = /^\/stage-instances\/(?<channel_id>.*?)$/i;
export const route = {
    method: "GET",
    template: Object.freeze({
        raw: "/stage-instances/{channel_id}" as const,
        keys: Object.freeze(["channel_id"] as const),
        segments: Object.freeze(["/stage-instances/",""] as const)
    }),
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `get /stage-instances/${model.channel_id}` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = GetStageInstanceRequestHeaders;
