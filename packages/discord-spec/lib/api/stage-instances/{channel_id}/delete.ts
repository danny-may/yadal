 ...
 */
import { type DeleteStageInstanceRequestPath, type DeleteStageInstanceRequestHeaders, type RateLimitError, type ErrorResponse } from '../../../types.js';
import { DiscordRestError, DiscordRateLimitError } from '../../../helpers.js';
export const name = "deleteStageInstance";
export type RouteModel = DeleteStageInstanceRequestPath;
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `delete /stage-instances/${model.channel_id}` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = DeleteStageInstanceRequestHeaders;
