 ...
 */
import { type GetGuildWidgetSettingsRequestPath, type GetGuildWidgetSettingsRequestHeaders, type WidgetSettingsResponse, type RateLimitError, type ErrorResponse } from '../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/guilds/{guild_id}/widget" as const,
        keys: Object.freeze(["guild_id"] as const),
        segments: Object.freeze(["/guilds/","/widget"] as const)
    }),
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `get /guilds/${model.guild_id}/widget` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = GetGuildWidgetSettingsRequestHeaders;
