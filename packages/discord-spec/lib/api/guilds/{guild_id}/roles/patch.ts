 ...
 */
import { type BulkUpdateGuildRolesRequestPath, type BulkUpdateGuildRolesRequestHeaders, type BulkUpdateGuildRolesResponseJSON, type RateLimitError, type ErrorResponse, type BulkUpdateGuildRolesRequestJSON } from '../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/guilds/{guild_id}/roles" as const,
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as BulkUpdateGuildRolesResponseJSON;
        }
