 ...
 */
import { type ListGuildTemplatesRequestPath, type ListGuildTemplatesRequestHeaders, type ListGuildTemplatesResponseJSON, type RateLimitError, type ErrorResponse } from '../../../../types.js';
import { DiscordRestError, DiscordRateLimitError } from '../../../../helpers.js';
export const name = "listGuildTemplates";
export type RouteModel = ListGuildTemplatesRequestPath;
const routeRegex = /^\/guilds\/(?<guild_id>.*?)\/templates$/i;
export const route = {
    method: "GET",
    template: Object.freeze({
        raw: "/guilds/{guild_id}/templates" as const,
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `get /guilds/${model.guild_id}/templates` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = ListGuildTemplatesRequestHeaders;
...
export type Response = ListGuildTemplatesResponseJSON;
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as ListGuildTemplatesResponseJSON;
        }
