 ...
 */
import { type SyncGuildTemplateRequestPath, type SyncGuildTemplateRequestHeaders, type GuildTemplateResponse, type RateLimitError, type ErrorResponse } from '../../../../../types.js';
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `put /guilds/${model.guild_id}/templates/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = SyncGuildTemplateRequestHeaders;
