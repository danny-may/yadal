 ...
 */
import { type UpdateGuildTemplateRequestPath, type UpdateGuildTemplateRequestHeaders, type GuildTemplateResponse, type RateLimitError, type ErrorResponse, type UpdateGuildTemplateRequestJSON } from '../../../../../types.js';
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `patch /guilds/${model.guild_id}/templates/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = UpdateGuildTemplateRequestHeaders;
