 ...
 */
import { type CreateGuildTemplateRequestPath, type CreateGuildTemplateRequestHeaders, type GuildTemplateResponse, type RateLimitError, type ErrorResponse, type CreateGuildTemplateRequestJSON } from '../../../../types.js';
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `post /guilds/${model.guild_id}/templates` as const;
    }
} as const;
