 ...
 */
import { type DeleteGuildStickerRequestPath, type DeleteGuildStickerRequestHeaders, type RateLimitError, type ErrorResponse } from '../../../../../types.js';
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `delete /guilds/${model.guild_id}/stickers/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = DeleteGuildStickerRequestHeaders;
