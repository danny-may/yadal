 ...
 */
import { type UpdateGuildStickerRequestPath, type UpdateGuildStickerRequestHeaders, type GuildStickerResponse, type RateLimitError, type ErrorResponse, type UpdateGuildStickerRequestJSON } from '../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/guilds/{guild_id}/stickers/{sticker_id}" as const,
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `patch /guilds/${model.guild_id}/stickers/<any>` as const;
    }
} as const;
