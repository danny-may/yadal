 ...
 */
import { type DeleteGuildScheduledEventRequestPath, type DeleteGuildScheduledEventRequestHeaders, type RateLimitError, type ErrorResponse } from '../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/guilds/{guild_id}/scheduled-events/{guild_scheduled_event_id}" as const,
