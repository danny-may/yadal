 ...
 */
import { type ListGuildScheduledEventUsersRequestPath, type ListGuildScheduledEventUsersRequestQuery, type ListGuildScheduledEventUsersRequestHeaders, type ListGuildScheduledEventUsersResponseJSON, type RateLimitError, type ErrorResponse } from '../../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/guilds/{guild_id}/scheduled-events/{guild_scheduled_event_id}/users" as const,
        keys: Object.freeze(["guild_id","guild_scheduled_event_id"] as const),
        segments: Object.freeze(["/guilds/","/scheduled-events/","/users"] as const)
    }),
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `get /guilds/${model.guild_id}/scheduled-events/<any>/users` as const;
    }
} as const;
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as ListGuildScheduledEventUsersResponseJSON;
        }
