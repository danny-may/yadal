 ...
 */
import { type ListGuildAuditLogEntriesRequestPath, type ListGuildAuditLogEntriesRequestQuery, type ListGuildAuditLogEntriesRequestHeaders, type GuildAuditLogResponse, type RateLimitError, type ErrorResponse } from '../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/guilds/{guild_id}/audit-logs" as const,
        keys: Object.freeze(["guild_id"] as const),
        segments: Object.freeze(["/guilds/","/audit-logs"] as const)
    }),
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as GuildAuditLogResponse;
        }
