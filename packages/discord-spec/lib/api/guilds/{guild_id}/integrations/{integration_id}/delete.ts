 ...
 */
import { type DeleteGuildIntegrationRequestPath, type DeleteGuildIntegrationRequestHeaders, type RateLimitError, type ErrorResponse } from '../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/guilds/{guild_id}/integrations/{integration_id}" as const,
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `delete /guilds/${model.guild_id}/integrations/<any>` as const;
    }
} as const;
