 ...
 */
import { type GetActiveGuildThreadsRequestPath, type GetActiveGuildThreadsRequestHeaders, type ThreadsResponse, type RateLimitError, type ErrorResponse } from '../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/guilds/{guild_id}/threads/active" as const,
        keys: Object.freeze(["guild_id"] as const),
        segments: Object.freeze(["/guilds/","/threads/active"] as const)
    }),
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `get /guilds/${model.guild_id}/threads/active` as const;
    }
} as const;
