 ...
 */
import { type UpdateSelfVoiceStateRequestPath, type UpdateSelfVoiceStateRequestHeaders, type RateLimitError, type ErrorResponse, type UpdateSelfVoiceStateRequestJSON } from '../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/guilds/{guild_id}/voice-states/@me" as const,
        keys: Object.freeze(["guild_id"] as const),
        segments: Object.freeze(["/guilds/","/voice-states/@me"] as const)
    }),
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `patch /guilds/${model.guild_id}/voice-states/@me` as const;
    }
} as const;
...
export function createBody(model: Body): { type: string; content: ArrayBufferView[]; } {
    return {
        ...
        content: [encoder.encode(JSON.stringify({
            "request_to_speak_timestamp": model["request_to_speak_timestamp" as keyof typeof model],
