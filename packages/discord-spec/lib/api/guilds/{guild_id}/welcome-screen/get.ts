 ...
 */
import { type GetGuildWelcomeScreenRequestPath, type GetGuildWelcomeScreenRequestHeaders, type GuildWelcomeScreenResponse, type RateLimitError, type ErrorResponse } from '../../../../types.js';
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `get /guilds/${model.guild_id}/welcome-screen` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = GetGuildWelcomeScreenRequestHeaders;
