 ...
 */
import { type UpdateGuildWelcomeScreenRequestPath, type UpdateGuildWelcomeScreenRequestHeaders, type GuildWelcomeScreenResponse, type RateLimitError, type ErrorResponse, type WelcomeScreenPatchRequestPartial } from '../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/guilds/{guild_id}/welcome-screen" as const,
        keys: Object.freeze(["guild_id"] as const),
        segments: Object.freeze(["/guilds/","/welcome-screen"] as const)
    }),
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `patch /guilds/${model.guild_id}/welcome-screen` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = UpdateGuildWelcomeScreenRequestHeaders;
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as GuildWelcomeScreenResponse;
        }
