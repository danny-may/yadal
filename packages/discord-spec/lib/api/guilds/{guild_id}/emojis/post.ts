 ...
 */
import { type CreateGuildEmojiRequestPath, type CreateGuildEmojiRequestHeaders, type EmojiResponse, type RateLimitError, type ErrorResponse, type CreateGuildEmojiRequestJSON } from '../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/guilds/{guild_id}/emojis" as const,
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `post /guilds/${model.guild_id}/emojis` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = CreateGuildEmojiRequestHeaders;
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 201) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as EmojiResponse;
        }
