 ...
 */
import { type AddThreadMemberRequestPath, type AddThreadMemberRequestHeaders, type RateLimitError, type ErrorResponse } from '../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/channels/{channel_id}/thread-members/{user_id}" as const,
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `put /channels/${model.channel_id}/thread-members/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = AddThreadMemberRequestHeaders;
