 ...
 */
import { type ListPublicArchivedThreadsRequestPath, type ListPublicArchivedThreadsRequestQuery, type ListPublicArchivedThreadsRequestHeaders, type ThreadsResponse, type RateLimitError, type ErrorResponse } from '../../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/channels/{channel_id}/threads/archived/public" as const,
        keys: Object.freeze(["channel_id"] as const),
        segments: Object.freeze(["/channels/","/threads/archived/public"] as const)
    }),
