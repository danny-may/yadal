 ...
 */
import { type ListMyPrivateArchivedThreadsRequestPath, type ListMyPrivateArchivedThreadsRequestQuery, type ListMyPrivateArchivedThreadsRequestHeaders, type ThreadsResponse, type RateLimitError, type ErrorResponse } from '../../../../../../../../types.js';
import { DiscordRestError, DiscordRateLimitError } from '../../../../../../../../helpers.js';
export const name = "listMyPrivateArchivedThreads";
export type RouteModel = ListMyPrivateArchivedThreadsRequestPath;
const routeRegex = /^\/channels\/(?<channel_id>.*?)\/users\/@me\/threads\/archived\/private$/i;
export const route = {
    method: "GET",
    template: Object.freeze({
        raw: "/channels/{channel_id}/users/@me/threads/archived/private" as const,
        keys: Object.freeze(["channel_id"] as const),
        segments: Object.freeze(["/channels/","/users/@me/threads/archived/private"] as const)
    }),
    authentication: Object.freeze({
        "BotToken": Object.freeze([] as const)
    } as const),
    get regex(){
        return /^\/channels\/(?<channel_id>.*?)\/users\/@me\/threads\/archived\/private$/i;
    },
    create(model: RouteModel) {
        return `/channels/${encodeURIComponent(model.channel_id)}/users/@me/threads/archived/private` as const satisfies `/${string}`;
    },
    test(url: `/${string}`) {
...
export type QueryModel = ListMyPrivateArchivedThreadsRequestQuery;
export const query = {
...
Object.freeze(query);
export type HeaderModel = ListMyPrivateArchivedThreadsRequestHeaders;
