 ...
 */
import { type UnpinMessageRequestPath, type UnpinMessageRequestHeaders, type RateLimitError, type ErrorResponse } from '../../../../../types.js';
import { DiscordRestError, DiscordRateLimitError } from '../../../../../helpers.js';
export const name = "unpinMessage";
export type RouteModel = UnpinMessageRequestPath;
const routeRegex = /^\/channels\/(?<channel_id>.*?)\/pins\/(?<message_id>.*?)$/i;
export const route = {
    method: "DELETE",
    template: Object.freeze({
        raw: "/channels/{channel_id}/pins/{message_id}" as const,
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `delete /channels/${model.channel_id}/pins/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = UnpinMessageRequestHeaders;
