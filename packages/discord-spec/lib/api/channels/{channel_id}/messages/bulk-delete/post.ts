 ...
 */
import { type BulkDeleteMessagesRequestPath, type BulkDeleteMessagesRequestHeaders, type RateLimitError, type ErrorResponse, type BulkDeleteMessagesRequestJSON } from '../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/channels/{channel_id}/messages/bulk-delete" as const,
        keys: Object.freeze(["channel_id"] as const),
        segments: Object.freeze(["/channels/","/messages/bulk-delete"] as const)
    }),
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `post /channels/${model.channel_id}/messages/bulk-delete` as const;
    }
} as const;
...
export function createBody(model: Body): { type: string; content: ArrayBufferView[]; } {
    return {
        ...
        content: [encoder.encode(JSON.stringify({
            "messages": model["messages" as keyof typeof model]
        }))]
    };
