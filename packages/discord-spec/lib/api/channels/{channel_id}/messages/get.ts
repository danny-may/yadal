 ...
 */
import { type ListMessagesRequestPath, type ListMessagesRequestQuery, type ListMessagesRequestHeaders, type ListMessagesResponseJSON, type RateLimitError, type ErrorResponse } from '../../../../types.js';
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as ListMessagesResponseJSON;
        }
