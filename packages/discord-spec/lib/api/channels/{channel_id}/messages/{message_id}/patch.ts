 ...
 */
import { type UpdateMessageRequestPath, type UpdateMessageRequestHeaders, type MessageResponse, type RateLimitError, type ErrorResponse, type MessageEditRequestPartial, type UpdateMessageRequestFormData } from '../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/channels/{channel_id}/messages/{message_id}" as const,
        keys: Object.freeze(["channel_id","message_id"] as const),
        segments: Object.freeze(["/channels/","/messages/",""] as const)
    }),
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `patch /channels/${model.channel_id}/messages/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = UpdateMessageRequestHeaders;
...
export type Body = (MessageEditRequestPartial | UpdateMessageRequestFormData);
    ...
    if (
        ...
        const chunks: ArrayBufferView[] = [
            ...
            encoder.encode(JSON.stringify({
                ...
                "sticker_ids": model["sticker_ids" as keyof typeof model],
