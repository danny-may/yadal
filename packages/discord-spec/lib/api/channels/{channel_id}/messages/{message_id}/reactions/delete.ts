 ...
 */
import { type DeleteAllMessageReactionsRequestPath, type DeleteAllMessageReactionsRequestHeaders, type RateLimitError, type ErrorResponse } from '../../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/channels/{channel_id}/messages/{message_id}/reactions" as const,
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `delete /channels/${model.channel_id}/messages/<any>/reactions` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = DeleteAllMessageReactionsRequestHeaders;
