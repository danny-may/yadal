 ...
 */
import { type ListMessageReactionsByEmojiRequestPath, type ListMessageReactionsByEmojiRequestQuery, type ListMessageReactionsByEmojiRequestHeaders, type ListMessageReactionsByEmojiResponseJSON, type RateLimitError, type ErrorResponse } from '../../../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/channels/{channel_id}/messages/{message_id}/reactions/{emoji_name}" as const,
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `get /channels/${model.channel_id}/messages/<any>/reactions/<any>` as const;
    }
} as const;
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as ListMessageReactionsByEmojiResponseJSON;
        }
