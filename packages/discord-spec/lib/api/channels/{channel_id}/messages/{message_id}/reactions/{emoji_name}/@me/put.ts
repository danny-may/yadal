 ...
 */
import { type AddMyMessageReactionRequestPath, type AddMyMessageReactionRequestHeaders, type RateLimitError, type ErrorResponse } from '../../../../../../../../types.js';
import { DiscordRestError, DiscordRateLimitError } from '../../../../../../../../helpers.js';
export const name = "addMyMessageReaction";
export type RouteModel = AddMyMessageReactionRequestPath;
const routeRegex = /^\/channels\/(?<channel_id>.*?)\/messages\/(?<message_id>.*?)\/reactions\/(?<emoji_name>.*?)\/@me$/i;
export const route = {
    method: "PUT",
    template: Object.freeze({
        raw: "/channels/{channel_id}/messages/{message_id}/reactions/{emoji_name}/@me" as const,
        keys: Object.freeze(["channel_id","message_id","emoji_name"] as const),
        segments: Object.freeze(["/channels/","/messages/","/reactions/","/@me"] as const)
    }),
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `put /channels/${model.channel_id}/messages/<any>/reactions/<any>/@me` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = AddMyMessageReactionRequestHeaders;
