 ...
 */
import { type GetMessageRequestPath, type GetMessageRequestHeaders, type MessageResponse, type RateLimitError, type ErrorResponse } from '../../../../../types.js';
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `get /channels/${model.channel_id}/messages/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = GetMessageRequestHeaders;
