 ...
 */
import { type CreateThreadFromMessageRequestPath, type CreateThreadFromMessageRequestHeaders, type ThreadResponse, type RateLimitError, type ErrorResponse, type CreateTextThreadWithMessageRequest } from '../../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/channels/{channel_id}/messages/{message_id}/threads" as const,
        keys: Object.freeze(["channel_id","message_id"] as const),
        segments: Object.freeze(["/channels/","/messages/","/threads"] as const)
    }),
