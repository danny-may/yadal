 ...
 */
import { type DeleteMyMessageReactionRequestPath, type DeleteMyMessageReactionRequestHeaders, type RateLimitError, type ErrorResponse } from '../../../../../../../../types.js';
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `delete /channels/${model.channel_id}/messages/<any>/reactions/<any>/@me` as const;
    }
} as const;
