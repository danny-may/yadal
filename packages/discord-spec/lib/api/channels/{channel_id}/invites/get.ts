 ...
 */
import { type ListChannelInvitesRequestPath, type ListChannelInvitesRequestHeaders, type ListChannelInvitesResponseJSON, type RateLimitError, type ErrorResponse } from '../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/channels/{channel_id}/invites" as const,
        keys: Object.freeze(["channel_id"] as const),
        segments: Object.freeze(["/channels/","/invites"] as const)
    }),
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `get /channels/${model.channel_id}/invites` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = ListChannelInvitesRequestHeaders;
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as ListChannelInvitesResponseJSON;
        }
