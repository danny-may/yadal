 ...
 */
import { type ListChannelWebhooksRequestPath, type ListChannelWebhooksRequestHeaders, type ListChannelWebhooksResponseJSON, type RateLimitError, type ErrorResponse } from '../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/channels/{channel_id}/webhooks" as const,
        keys: Object.freeze(["channel_id"] as const),
        segments: Object.freeze(["/channels/","/webhooks"] as const)
    }),
...
export const rateLimit = {
    ...
    bucket(model: { [P in "channel_id"]: RouteModel[P] | string; }) {
        return `get /channels/${model.channel_id}/webhooks` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = ListChannelWebhooksRequestHeaders;
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as ListChannelWebhooksResponseJSON;
        }
