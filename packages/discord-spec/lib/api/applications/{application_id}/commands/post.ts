 ...
 */
import { type CreateApplicationCommandRequestPath, type CreateApplicationCommandRequestHeaders, type ApplicationCommandResponse, type RateLimitError, type ErrorResponse, type CreateApplicationCommandRequestJSON } from '../../../../types.js';
...
export const rateLimit = {
    ...
    bucket(_?: { [P in never]: RouteModel[P] | string; }) {
        return `post /applications/<any>/commands` as const;
    }
} as const;
