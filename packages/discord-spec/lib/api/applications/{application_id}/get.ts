 ...
 */
import { type GetApplicationRequestPath, type GetApplicationRequestHeaders, type PrivateApplicationResponse, type RateLimitError, type ErrorResponse } from '../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/applications/{application_id}" as const,
        keys: Object.freeze(["application_id"] as const),
        segments: Object.freeze(["/applications/",""] as const)
    }),
...
export const rateLimit = {
    ...
    bucket(_?: { [P in never]: RouteModel[P] | string; }) {
        return `get /applications/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = GetApplicationRequestHeaders;
