 ...
 */
import { type ListGuildApplicationCommandPermissionsRequestPath, type ListGuildApplicationCommandPermissionsRequestHeaders, type ListGuildApplicationCommandPermissionsResponseJSON, type RateLimitError, type ErrorResponse } from '../../../../../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/applications/{application_id}/guilds/{guild_id}/commands/permissions" as const,
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `get /applications/<any>/guilds/${model.guild_id}/commands/permissions` as const;
    }
} as const;
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as ListGuildApplicationCommandPermissionsResponseJSON;
        }
