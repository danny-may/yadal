 ...
 */
import { type GetBotGatewayRequestHeaders, type GatewayBotResponse, type RateLimitError, type ErrorResponse } from '../../../types.js';
...
export const route = {
    ...
    template: Object.freeze({
        raw: "/gateway/bot" as const,
        keys: Object.freeze([] as const),
        segments: Object.freeze(["/gateway/bot"] as const)
    }),
...
Object.freeze(query);
export type HeaderModel = GetBotGatewayRequestHeaders;
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as GatewayBotResponse;
        }
