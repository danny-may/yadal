 ...
 */
import { type UnbanUserFromGuildRequestPath, type UnbanUserFromGuildRequestHeaders, type RateLimitError, type ErrorResponse } from '../../../../../types.js';
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `delete /guilds/${model.guild_id}/bans/<any>` as const;
    }
} as const;
