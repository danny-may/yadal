 ...
 */
import { type GetMyOauth2AuthorizationRequestHeaders, type OAuth2GetAuthorizationResponse, type RateLimitError, type ErrorResponse } from '../../../types.js';
...
export async function readResponse(statusCode: number, contentType: string | undefined, content: () => Promise<ArrayBufferView>): Promise<Response> {
    if (statusCode === 200) {
        if (contentType === "application/json") {
            return JSON.parse(decode(await content())) as OAuth2GetAuthorizationResponse;
        }
