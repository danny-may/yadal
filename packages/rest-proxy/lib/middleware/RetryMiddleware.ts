...
export class RetryMiddleware implements IDiscordRestProxyMiddleware {
    async handle<T extends object>(_route: IRoute<T>, _params: T, _request: IHttpRequest, next: (signal?: AbortSignal | undefined) => PromiseLike<IHttpResponse>, signal?: AbortSignal | undefined): Promise<IHttpResponse> {
        while (true) {
