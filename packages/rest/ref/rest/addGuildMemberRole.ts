 ...
 */
import { type AddGuildMemberRoleRequestPath, type AddGuildMemberRoleRequestHeaders, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const rateLimit = {
    ...
    bucket(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return `put /guilds/${model.guild_id}/members/<any>/roles/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = AddGuildMemberRoleRequestHeaders;
