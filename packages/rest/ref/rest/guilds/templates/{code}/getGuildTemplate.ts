 ...
 */
import { type GetGuildTemplateRequestPath, type GetGuildTemplateRequestHeaders, type GuildTemplateResponse, type RateLimitError, type ErrorResponse } from '../../../../discord.js';
...
export const rateLimit = {
    ...
    bucket(_?: { [P in never]: RouteModel[P] | string; }) {
        return `get /guilds/templates/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = GetGuildTemplateRequestHeaders;
