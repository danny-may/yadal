 ...
 */
import { type DeleteGuildMemberRequestPath, type DeleteGuildMemberRequestHeaders, type RateLimitError, type ErrorResponse } from '../../../../../discord.js';
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `delete /guilds/${model.guild_id}/members/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = DeleteGuildMemberRequestHeaders;
