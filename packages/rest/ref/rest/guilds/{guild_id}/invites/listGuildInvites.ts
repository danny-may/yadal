 ...
 */
import { type ListGuildInvitesRequestPath, type ListGuildInvitesRequestHeaders, type ListGuildInvitesResponseJSON, type RateLimitError, type ErrorResponse } from '../../../../discord.js';
...
export const route = {
    method: "GET",
    template: "/guilds/{guild_id}/invites",
