 ...
 */
import { type UpdateGuildEmojiRequestPath, type UpdateGuildEmojiRequestHeaders, type EmojiResponse, type RateLimitError, type ErrorResponse, type UpdateGuildEmojiRequestJSON } from '../../../../../discord.js';
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `patch /guilds/${model.guild_id}/emojis/<any>` as const;
    }
} as const;
