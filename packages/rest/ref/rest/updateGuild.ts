 ...
 */
import { type UpdateGuildRequestPath, type UpdateGuildRequestHeaders, type GuildResponse, type RateLimitError, type ErrorResponse, type GuildPatchRequestPartial } from '../discord.js';
