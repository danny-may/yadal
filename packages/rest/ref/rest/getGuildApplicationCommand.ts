 ...
 */
import { type GetGuildApplicationCommandRequestPath, type GetGuildApplicationCommandRequestHeaders, type ApplicationCommandResponse, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const rateLimit = {
    ...
    bucket(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return `get /applications/<any>/guilds/${model.guild_id}/commands/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = GetGuildApplicationCommandRequestHeaders;
