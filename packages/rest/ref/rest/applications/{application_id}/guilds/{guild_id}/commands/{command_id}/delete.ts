 ...
 */
import { type DeleteGuildApplicationCommandRequestPath, type DeleteGuildApplicationCommandRequestHeaders, type RateLimitError, type ErrorResponse } from '../../../../../../../types.js';
...
export const rateLimit = {
    ...
    bucket(model: { [P in "guild_id"]: RouteModel[P] | string; }) {
        return `delete /applications/<any>/guilds/${model.guild_id}/commands/<any>` as const;
    }
} as const;
