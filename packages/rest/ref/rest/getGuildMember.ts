 ...
 */
import { type GetGuildMemberRequestPath, type GetGuildMemberRequestHeaders, type GuildMemberResponse, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const rateLimit = {
    ...
    bucket(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return `get /guilds/${model.guild_id}/members/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = GetGuildMemberRequestHeaders;
