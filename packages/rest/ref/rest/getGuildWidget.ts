 ...
 */
import { type GetGuildWidgetRequestPath, type GetGuildWidgetRequestHeaders, type WidgetResponse, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const route = {
    method: "GET",
    template: "/guilds/{guild_id}/widget.json",
