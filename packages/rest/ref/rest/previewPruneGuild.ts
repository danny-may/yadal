 ...
 */
import { type PreviewPruneGuildRequestPath, type PreviewPruneGuildRequestHeaders, type GuildPruneResponse, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const rateLimit = {
    ...
    bucket(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return `get /guilds/${model.guild_id}/prune` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = PreviewPruneGuildRequestHeaders;
