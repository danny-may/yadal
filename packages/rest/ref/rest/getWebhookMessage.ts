 ...
 */
import { type GetWebhookMessageRequestPath, type GetWebhookMessageRequestQuery, type GetWebhookMessageRequestHeaders, type RateLimitError, type MessageResponse, type ErrorResponse } from '../discord.js';
...
export const rateLimit = {
    ...
    bucket(model: { ["webhook_id"]: RouteModel["webhook_id"] | string; ["webhook_token"]: RouteModel["webhook_token"] | string; }) {
        return `get /webhooks/${model.webhook_id}/${model.webhook_token}/messages/<any>` as const;
    }
} as const;
...
Object.freeze(query);
export type HeaderModel = GetWebhookMessageRequestHeaders;
