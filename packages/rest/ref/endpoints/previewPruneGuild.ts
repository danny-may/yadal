 ...
 */
import { type PreviewPruneGuildRequestPath, type PreviewPruneGuildRequestHeaders, type RateLimitError, type GuildPruneResponse, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return ["global", `get /guilds/${model.guild_id}/prune`] as const;
    }
} as const;
Object.freeze(route);
