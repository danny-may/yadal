 ...
 */
import { type LeaveThreadRequestPath, type LeaveThreadRequestHeaders, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["channel_id"]: RouteModel["channel_id"] | string; }) {
        return ["global", `delete /channels/${model.channel_id}/thread-members/@me`] as const;
    }
} as const;
Object.freeze(route);
