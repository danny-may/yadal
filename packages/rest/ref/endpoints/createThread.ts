 ...
 */
import { type CreateThreadRequestPath, type CreatedThreadResponse, type ErrorResponse, type CreateThreadRequestJSON, type CreateThreadRequestURLEncoded, type CreateThreadRequestFormData } from '../discord.js';
import { DiscordRestError } from '../helpers.js';
export const method = "POST";
export const name = "createThread";
export type RouteModel = CreateThreadRequestPath;
export const route = "/channels/{channel_id}/threads";
