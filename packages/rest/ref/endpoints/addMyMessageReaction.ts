 ...
 */
import { type AddMyMessageReactionRequestPath, type AddMyMessageReactionRequestHeaders, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["channel_id"]: RouteModel["channel_id"] | string; }) {
        return ["global", `put /channels/${model.channel_id}/messages/<any>/reactions/<any>/@me`] as const;
    }
} as const;
Object.freeze(route);
