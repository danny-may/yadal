 ...
 */
import { type GetGuildApplicationCommandPermissionsRequestPath, type GetGuildApplicationCommandPermissionsRequestHeaders, type RateLimitError, type CommandPermissionsResponse, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return ["global", `get /applications/<any>/guilds/${model.guild_id}/commands/<any>/permissions`] as const;
    }
} as const;
Object.freeze(route);
...
Object.freeze(query);
export type HeaderModel = GetGuildApplicationCommandPermissionsRequestHeaders;
