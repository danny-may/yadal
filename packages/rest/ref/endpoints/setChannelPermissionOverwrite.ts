 ...
 */
import { type SetChannelPermissionOverwriteRequestPath, type RateLimitError, type ErrorResponse, type SetChannelPermissionOverwriteRequestJSON } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["channel_id"]: RouteModel["channel_id"] | string; }) {
        return ["global", `put /channels/${model.channel_id}/permissions/<any>`] as const;
    }
} as const;
Object.freeze(route);
