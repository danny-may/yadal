 ...
 */
import { type CreateMessageRequestPath, type RateLimitError, type MessageResponse, type ErrorResponse, type MessageCreateRequest, type CreateMessageRequestFormData } from '../discord.js';
