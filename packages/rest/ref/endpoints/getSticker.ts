 ...
 */
import { type GetStickerRequestPath, type RateLimitError, type GetStickerResponseJSON, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(_: {}) {
        return ["global", `get /stickers/<any>`] as const;
    }
} as const;
Object.freeze(route);
