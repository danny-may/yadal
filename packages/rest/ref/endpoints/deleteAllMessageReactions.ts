 ...
 */
import { type DeleteAllMessageReactionsRequestPath, type ErrorResponse } from '../discord.js';
import { DiscordRestError } from '../helpers.js';
export const method = "DELETE";
export const name = "deleteAllMessageReactions";
export type RouteModel = DeleteAllMessageReactionsRequestPath;
export const route = "/channels/{channel_id}/messages/{message_id}/reactions";
