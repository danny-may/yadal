 ...
 */
import { type DeleteStageInstanceRequestPath, type DeleteStageInstanceRequestHeaders, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["channel_id"]: RouteModel["channel_id"] | string; }) {
        return ["global", `delete /stage-instances/${model.channel_id}`] as const;
    }
} as const;
Object.freeze(route);
