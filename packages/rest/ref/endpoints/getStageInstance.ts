 ...
 */
import { type GetStageInstanceRequestPath, type GetStageInstanceRequestHeaders, type RateLimitError, type StageInstanceResponse, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["channel_id"]: RouteModel["channel_id"] | string; }) {
        return ["global", `get /stage-instances/${model.channel_id}`] as const;
    }
} as const;
Object.freeze(route);
