 ...
 */
import { type DeleteGuildRequestPath, type DeleteGuildRequestHeaders, type RateLimitError, type ErrorResponse } from '../discord.js';
...
Object.freeze(query);
export type HeaderModel = DeleteGuildRequestHeaders;
