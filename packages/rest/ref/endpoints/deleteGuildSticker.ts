 ...
 */
import { type DeleteGuildStickerRequestPath, type DeleteGuildStickerRequestHeaders, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return ["global", `delete /guilds/${model.guild_id}/stickers/<any>`] as const;
    }
} as const;
Object.freeze(route);
