 ...
 */
import { type ListGuildIntegrationsRequestPath, type ListGuildIntegrationsResponseJSON, type ErrorResponse } from '../discord.js';
import { DiscordRestError } from '../helpers.js';
export const method = "GET";
export const name = "listGuildIntegrations";
export type RouteModel = ListGuildIntegrationsRequestPath;
export const route = "/guilds/{guild_id}/integrations";
