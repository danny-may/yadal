 ...
 */
import { type UpdateMessageRequestPath, type RateLimitError, type MessageResponse, type ErrorResponse, type MessageEditRequestPartial, type UpdateMessageRequestFormData } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["channel_id"]: RouteModel["channel_id"] | string; }) {
        return ["global", `patch /channels/${model.channel_id}/messages/<any>`] as const;
    }
} as const;
Object.freeze(route);
