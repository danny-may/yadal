 ...
 */
import { type UpdateMessageRequestPath, type MessageResponse, type ErrorResponse, type MessageEditRequestPartial, type UpdateMessageRequestFormData } from '../discord.js';
