 ...
 */
import { type GetMyGuildMemberRequestPath, type PrivateGuildMemberResponse, type ErrorResponse } from '../discord.js';
import { DiscordRestError } from '../helpers.js';
export const method = "GET";
export const name = "getMyGuildMember";
export type RouteModel = GetMyGuildMemberRequestPath;
export const route = "/users/@me/guilds/{guild_id}/member";
