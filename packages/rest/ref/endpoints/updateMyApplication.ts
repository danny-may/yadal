...
import { type RateLimitError, type PrivateApplicationResponse, type ErrorResponse, type ApplicationFormPartial } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(_: {}) {
        return ["global", `patch /applications/@me`] as const;
    }
} as const;
Object.freeze(route);
