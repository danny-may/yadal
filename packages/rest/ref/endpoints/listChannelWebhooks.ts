 ...
 */
import { type ListChannelWebhooksRequestPath, type ListChannelWebhooksResponseJSON, type ErrorResponse } from '../discord.js';
import { DiscordRestError } from '../helpers.js';
export const method = "GET";
export const name = "listChannelWebhooks";
export type RouteModel = ListChannelWebhooksRequestPath;
export const route = "/channels/{channel_id}/webhooks";
