 ...
 */
import { type ListPrivateArchivedThreadsRequestPath, type ListPrivateArchivedThreadsRequestQuery, type ThreadsResponse, type ErrorResponse } from '../discord.js';
import { DiscordRestError } from '../helpers.js';
export const method = "GET";
export const name = "listPrivateArchivedThreads";
export type RouteModel = ListPrivateArchivedThreadsRequestPath;
export const route = "/channels/{channel_id}/threads/archived/private";
