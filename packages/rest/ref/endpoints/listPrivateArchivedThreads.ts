 ...
 */
import { type ListPrivateArchivedThreadsRequestPath, type ListPrivateArchivedThreadsRequestQuery, type RateLimitError, type ThreadsResponse, type ErrorResponse } from '../discord.js';
