 ...
 */
import { type DeleteApplicationCommandRequestPath, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(_: {}) {
        return ["global", `delete /applications/<any>/commands/<any>`] as const;
    }
} as const;
Object.freeze(route);
