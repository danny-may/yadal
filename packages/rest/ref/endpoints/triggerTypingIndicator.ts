 ...
 */
import { type TriggerTypingIndicatorRequestPath, type RateLimitError, type TypingIndicatorResponse, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["channel_id"]: RouteModel["channel_id"] | string; }) {
        return ["global", `post /channels/${model.channel_id}/typing`] as const;
    }
} as const;
Object.freeze(route);
