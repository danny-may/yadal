 ...
 */
import { type GetChannelRequestPath, type RateLimitError, type GetChannelResponseJSON, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["channel_id"]: RouteModel["channel_id"] | string; }) {
        return ["global", `get /channels/${model.channel_id}`] as const;
    }
} as const;
Object.freeze(route);
