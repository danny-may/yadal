 ...
 */
import { type CreateApplicationCommandRequestPath, type ApplicationCommandResponse, type ErrorResponse, type CreateApplicationCommandRequestJSON } from '../discord.js';
