 ...
 */
import { type CreateApplicationCommandRequestPath, type RateLimitError, type ApplicationCommandResponse, type ErrorResponse, type CreateApplicationCommandRequestJSON } from '../discord.js';
