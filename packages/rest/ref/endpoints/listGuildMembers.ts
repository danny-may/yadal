 ...
 */
import { type ListGuildMembersRequestPath, type ListGuildMembersRequestQuery, type ListGuildMembersResponseJSON, type ErrorResponse } from '../discord.js';
import { DiscordRestError } from '../helpers.js';
export const method = "GET";
export const name = "listGuildMembers";
export type RouteModel = ListGuildMembersRequestPath;
export const route = "/guilds/{guild_id}/members";
export const routeKeys = Object.freeze(["guild_id"] as const);
export type QueryModel = ListGuildMembersRequestQuery;
export const queryKeys = Object.freeze(["limit", "after"] as const);
