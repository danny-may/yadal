 ...
 */
import { type GetApplicationRequestPath, type RateLimitError, type PrivateApplicationResponse, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(_: {}) {
        return ["global", `get /applications/<any>`] as const;
    }
} as const;
Object.freeze(route);
