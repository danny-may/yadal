 ...
 */
import { type BanUserFromGuildRequestPath, type BanUserFromGuildRequestHeaders, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return ["global", `put /guilds/${model.guild_id}/bans/<any>`] as const;
    }
} as const;
Object.freeze(route);
...
Object.freeze(query);
export type HeaderModel = BanUserFromGuildRequestHeaders;
