 ...
 */
import { type GetApplicationCommandRequestPath, type GetApplicationCommandRequestHeaders, type RateLimitError, type ApplicationCommandResponse, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(_?: {  }) {
        return ["global", `get /applications/<any>/commands/<any>`] as const;
    }
} as const;
Object.freeze(route);
...
Object.freeze(query);
export type HeaderModel = GetApplicationCommandRequestHeaders;
