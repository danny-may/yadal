 ...
 */
import { type ListGuildEmojisRequestPath, type RateLimitError, type ListGuildEmojisResponseJSON, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return ["global", `get /guilds/${model.guild_id}/emojis`] as const;
    }
} as const;
Object.freeze(route);
