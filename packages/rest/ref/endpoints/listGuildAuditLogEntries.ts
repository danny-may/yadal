 ...
 */
import { type ListGuildAuditLogEntriesRequestPath, type ListGuildAuditLogEntriesRequestQuery, type RateLimitError, type GuildAuditLogResponse, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return ["global", `get /guilds/${model.guild_id}/audit-logs`] as const;
    }
} as const;
Object.freeze(route);
