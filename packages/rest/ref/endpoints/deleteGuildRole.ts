 ...
 */
import { type DeleteGuildRoleRequestPath, type DeleteGuildRoleRequestHeaders, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return ["global", `delete /guilds/${model.guild_id}/roles/<any>`] as const;
    }
} as const;
Object.freeze(route);
...
Object.freeze(query);
export type HeaderModel = DeleteGuildRoleRequestHeaders;
