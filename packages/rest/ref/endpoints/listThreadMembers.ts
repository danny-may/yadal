 ...
 */
import { type ListThreadMembersRequestPath, type ListThreadMembersRequestQuery, type ListThreadMembersResponseJSON, type ErrorResponse } from '../discord.js';
import { DiscordRestError } from '../helpers.js';
export const method = "GET";
export const name = "listThreadMembers";
export type RouteModel = ListThreadMembersRequestPath;
export const route = "/channels/{channel_id}/thread-members";
