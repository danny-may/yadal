 ...
 */
import { type ListMyPrivateArchivedThreadsRequestPath, type ListMyPrivateArchivedThreadsRequestQuery, type ThreadsResponse, type ErrorResponse } from '../discord.js';
import { DiscordRestError } from '../helpers.js';
export const method = "GET";
export const name = "listMyPrivateArchivedThreads";
export type RouteModel = ListMyPrivateArchivedThreadsRequestPath;
export const route = "/channels/{channel_id}/users/@me/threads/archived/private";
