 ...
 */
import { type DeleteGroupDmUserRequestPath, type DeleteGroupDmUserRequestHeaders, type RateLimitError, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["channel_id"]: RouteModel["channel_id"] | string; }) {
        return ["global", `delete /channels/${model.channel_id}/recipients/<any>`] as const;
    }
} as const;
Object.freeze(route);
...
Object.freeze(query);
export type HeaderModel = DeleteGroupDmUserRequestHeaders;
