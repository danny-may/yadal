 ...
 */
import { type GetGuildEmojiRequestPath, type RateLimitError, type EmojiResponse, type ErrorResponse } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return ["global", `get /guilds/${model.guild_id}/emojis/<any>`] as const;
    }
} as const;
Object.freeze(route);
