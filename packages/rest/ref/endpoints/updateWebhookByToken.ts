 ...
 */
import { type UpdateWebhookByTokenRequestPath, type UpdateWebhookByTokenRequestHeaders, type RateLimitError, type UpdateWebhookByTokenResponseJSON, type ErrorResponse, type UpdateWebhookByTokenRequestJSON } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["webhook_id"]: RouteModel["webhook_id"] | string; ["webhook_token"]: RouteModel["webhook_token"] | string; }) {
        return ["global", `patch /webhooks/${model.webhook_id}/${model.webhook_token}`] as const;
    }
} as const;
Object.freeze(route);
