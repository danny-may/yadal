 ...
 */
import { type CreateAutoModerationRuleRequestPath, type RateLimitError, type CreateAutoModerationRuleResponseJSON, type ErrorResponse, type CreateAutoModerationRuleRequestJSON } from '../discord.js';
...
export const route = {
    ...
    rateLimitBuckets(model: { ["guild_id"]: RouteModel["guild_id"] | string; }) {
        return ["global", `post /guilds/${model.guild_id}/auto-moderation/rules`] as const;
    }
} as const;
Object.freeze(route);
