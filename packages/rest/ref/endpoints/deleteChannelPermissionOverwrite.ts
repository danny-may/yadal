 ...
 */
import { type DeleteChannelPermissionOverwriteRequestPath, type DeleteChannelPermissionOverwriteRequestHeaders, type RateLimitError, type ErrorResponse } from '../discord.js';
import { DiscordRestError, DiscordRateLimitError } from '../helpers.js';
export const name = "deleteChannelPermissionOverwrite";
export type RouteModel = DeleteChannelPermissionOverwriteRequestPath;
...
export const route = {
    ...
    rateLimitBuckets(model: { ["channel_id"]: RouteModel["channel_id"] | string; }) {
        return ["global", `delete /channels/${model.channel_id}/permissions/<any>`] as const;
    }
} as const;
Object.freeze(route);
...
Object.freeze(query);
export type HeaderModel = DeleteChannelPermissionOverwriteRequestHeaders;
