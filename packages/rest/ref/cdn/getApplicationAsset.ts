 ...
 */
import { type GetApplicationAssetRequestPath } from '../discord.js';
...
export const route = {
    method: "GET",
    template: "/app-assets/{application_id}/{asset_id}.{format}",
...
export const rateLimit = {
    global: false,
    bucket(_?: {  }) {
        return `get /app-assets/<any>/<any>.<any>` as const;
    }
} as const;
